...
class AdvancedDrawerSource extends StatefulWidget {
  const AdvancedDrawerSource({
    super.key,
    required this.child,
  ...
  @override
  AdvancedDrawerSourceState createState() => AdvancedDrawerSourceState();
}

class AdvancedDrawerSourceState extends State<AdvancedDrawerSource> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant AdvancedDrawerSource oldWidget) {
    _initControllers();
                          ...
                          ValueListenableBuilder<AdvancedDrawerValue>(
                            ...
                            builder: (_, value, __) {
                              ...
                              return Material(
                                color: Colors.transparent,
                                child: InkWell(
                                  // onTap: _controller.hideDrawer, //! CLOSE ON TAP ON SCREEN
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    ...
    _animationController.value = _offsetValue + (diff / (screenSize.width * widget.openRatio)) * (widget.rtlOpening ? -1 : 1);
  }
...
class AdvancedDrawerController extends ValueNotifier<AdvancedDrawerValue> {
  ...
  AdvancedDrawerController([AdvancedDrawerValue? value]) : super(value ?? AdvancedDrawerValue.hidden());
